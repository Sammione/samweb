        ...
        <main className="min-h-screen bg-[#0B0F1A]">
            ...
            <div className="pt-32 pb-24 section-padding max-w-4xl mx-auto">
                ...
                <div className="prose prose-invert prose-blue max-w-none text-gray-400 space-y-6">
                    ...
                    <p>By accessing or using the NeuraCore AI website and services, you agree to be bound by these Terms of Service.</p>
                    ...
                    <p>All content on this website, including text, graphics, logos, and course materials, is the property of NeuraCore AI and is protected by copyright and other intellectual property laws.</p>

                    <h2 className="text-2xl font-bold text-white mt-8 mb-4">4. Limitation of Liability</h2>
                    <p>NeuraCore AI shall not be liable for any direct, indirect, incidental, or consequential damages resulting from your use of, or inability to use, our services.</p>

                    <h2 className="text-2xl font-bold text-white mt-8 mb-4">5. Governing Law</h2>
                    <p>These terms are governed by and construed in accordance with the laws of the jurisdictions in which NeuraCore AI operates (Nigeria and Kenya).</p>
